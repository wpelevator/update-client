...
class Signed_Package {
	...
	public function download( string $url ): string {
		...
		if ( ! $this->signature_verified ) {
			...
			throw new RuntimeException(
				sprintf( 'The signature of the package downloaded from %s was never verified', $url )
			);
		}
	...
	public function filter_extend_trusted_keys( array $keys ): array {
		$this->signature_verified = true; // Assume that signature was verified by WP core if this filter is called.
